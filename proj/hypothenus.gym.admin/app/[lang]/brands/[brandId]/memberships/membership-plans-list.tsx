...
import { CartState } from "@/app/lib/store/slices/cart-state-slice";

export default function MembershipPlansList({ lang, brandId, membershipPlans }:
  {
    lang: string;
    brandId: string;
        ...
        <div className="w-100">
          ...
          <div className="d-flex flex-row flex-wrap">
            {promotionalPlans.map((membershipPlan) => (
              <MembershipPlansListDetails key={membershipPlan.uuid} lang={lang} brandId={brandId} membershipPlan={membershipPlan} />
            ))}
          </div>
          <hr />
        </div>
