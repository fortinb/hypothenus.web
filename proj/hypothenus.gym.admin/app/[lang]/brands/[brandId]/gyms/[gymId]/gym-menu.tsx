          ...
          <Row className="gx-2">
            <Col xs={6} >
              <div className="btn-navigation m-2">
                <div className="d-flex flex-column justify-content-center h-100">
                  <div className="d-flex flex-row justify-content-center">
                    <Link className={"link-element" + (gymState.gym.id == null ? " link-element-disabled" : "")} href={`/${i18n.resolvedLanguage}/brands/${brandId}/gyms/${gymId}`}><i className="icon icon-secondary bi bi-building h1 m-0"></i></Link>
                  </div>
                  <div className="d-flex flex-row justify-content-center">
            ...
            <Col xs={6} >
              <div className="btn-navigation m-2">
                <div className="d-flex flex-column justify-content-center h-100">
                  <div className="d-flex flex-row justify-content-center">
                    <Link className={"link-element" + (gymState.gym.id == null ? " link-element-disabled" : "")} href={`/${i18n.resolvedLanguage}/brands/${brandId}/gyms/${gymId}/coachs`}><i className="icon icon-secondary bi-person-arms-up h1 m-0"></i></Link>
                  </div>
                  <div className="d-flex flex-row justify-content-center">
          ...
          <Row className="gx-2">
            <Col xs={6} >
              <div className="btn-navigation m-2">
                <div className="d-flex flex-column justify-content-center h-100">
                  <div className="d-flex flex-row justify-content-center">
                  <Link className={"link-element" + (gymState.gym.id == null ? " link-element-disabled" : "")} href={`/${i18n.resolvedLanguage}/brands/${brandId}/gyms/${gymId}/courses`}><i className="icon icon-secondary bi-bicycle h1 m-0"></i></Link>
                  </div>
                  <div className="d-flex flex-row justify-content-center">
