...
export default function Coach() {
  const params = useParams<{ gymId: string, coachId: string }>();

  return (
    <div className="d-flex justify-content-between w-100 h-100">
      <div className="d-flex flex-column justify-content-between w-25 h-100 ms-4 me-4">
        <CoachMenu gymId={params.gymId} coachId={params.coachId} />
      </div>
      <div className="d-flex flex-column justify-content-between w-50 h-100">
        <CoachForm gymId={params.gymId} coachId={params.coachId} />
      </div>
      <div className="d-flex flex-column justify-content-between w-25 h-100 ms-4 me-4">
        <CoachResume />
      </div>
