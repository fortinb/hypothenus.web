...
export default function BrandMenu({ lang, brand }: { lang: string, brand: Brand }) {
  ...
  return (
    ...
    <div className="d-flex flex-column justify-content-start w-100 h-75 page-menu">
          ...
          <Row className="gx-2">
            ...
            <Col xs={6} >
              <div className="btn-navigation m-2">
                <div className="d-flex flex-column justify-content-center h-100">
                  <div className="d-flex flex-row justify-content-center">
                    <Link className={"link-element" + (brand.uuid === null ? " link-element-disabled" : "")} href={`/${lang}/admin/brands/${brand.uuid}/courses`}><i className="icon icon-secondary bi-bicycle h1 m-0"></i></Link>
                  </div>
                  <div className="d-flex flex-row justify-content-center">
          ...
          <Row className="gx-2">
            <Col xs={6} >
              <div className="btn-navigation m-2">
                <div className="d-flex flex-column justify-content-center h-100">
                  <div className="d-flex flex-row justify-content-center">
                    <Link className={"link-element" + (brand.uuid === null ? " link-element-disabled" : "")} href={`/${lang}/admin/brands/${brand.uuid}/coachs`}><i className="icon icon-secondary bi-person-arms-up h1 m-0"></i></Link>
                  </div>
                  <div className="d-flex flex-row justify-content-center">
            ...
            <Col xs={6} >
              <div className="btn-navigation m-2">
                <div className="d-flex flex-column justify-content-center h-100">
                  <div className="d-flex flex-row justify-content-center">
                    <Link className={"link-element" + (brand.uuid === null ? " link-element-disabled" : "")} href={`/${lang}/admin/brands/${brand.uuid}/membership-plans`}><i className="icon icon-secondary bi-person-gear h1 m-0"></i></Link>
                  </div>
                  <div className="d-flex flex-row justify-content-center">
                    <span className="text-primary mt-3">{t("menu.membershipPlans")}</span>
                  </div>
                </div>
              </div>
            </Col>
