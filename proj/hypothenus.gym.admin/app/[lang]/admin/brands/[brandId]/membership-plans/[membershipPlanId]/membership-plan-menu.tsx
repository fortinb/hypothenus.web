...
export default function MembershipPlanMenu({ lang, membershipPlan }: { lang: string; membershipPlan: MembershipPlan }) {
      ...
      <div className="d-flex flex-row h-50">
        <div className="col btn-navigation m-2">
          <div className="d-flex flex-column justify-content-center h-100">
            <div className="d-flex flex-row justify-content-center">
              <Link className={"link-element" + (membershipPlan.uuid === null ? " link-element-disabled" : "")} href={`/${lang}/admin/brands/${membershipPlan.brandUuid}/membership-plans/${membershipPlan.uuid}`}><i className="icon icon-secondary bi-person-gear  h1 m-0"></i></Link>
            </div>
            <div className="d-flex flex-row justify-content-center">
