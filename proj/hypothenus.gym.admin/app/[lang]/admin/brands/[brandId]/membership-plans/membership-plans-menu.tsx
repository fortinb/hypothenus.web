...
import { MembershipPlansStatePaging, includeInactive } from "@/app/lib/store/slices/membership-plans-state-paging-slice";
import { BrandState } from "@/app/lib/store/slices/brand-state-slice";

export default function MembershipPlansMenu({ lang }: { lang: string; }) {
    ...
    <div className="d-flex flex-column justify-content-start w-100 h-50 page-menu">
      <div className="d-flex flex-row justify-content-center">
        <h2 className="text-secondary pt-4 ps-2">{t("list.menu.title")}
          <i className="icon icon-secondary bi bi-person-gear ms-2"></i>
        </h2>
      </div>
            ...
            <Col xs={6} >
              <div className="btn-navigation m-2">
                <div className="d-flex flex-column justify-content-center h-100">
                  <div className="d-flex flex-row justify-content-center">
                    <Link className="link-element" href={`/${lang}/admin/brands/${brandState?.brand?.uuid}/membership-plans/new`}><i className="icon icon-secondary bi bi-plus-square h1 m-0"></i></Link>
                  </div>
                  <div className="d-flex flex-row justify-content-center">
              ...
              <div className="d-flex flex-row align-items-center justify-content-center flex-fill h-100">
                <div className="form-check form-switch pe-2">
                  <Form.Control className="form-check-input form-check-input-lg" type="checkbox" role="switch" name="includeDeactivate"
                    id="flexSwitchCheckChecked" onChange={onIncludeDeactivated} checked={membershipPlansStatePaging.includeInactive} />
